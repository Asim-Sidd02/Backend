...
# Allow specific hosts only (adjust as needed for production)
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'backend-31us.onrender.com',
    'signsense.vercel.app',  # Replace with your frontend domain
]
...
# CSRF Trusted Origins (add the domains that you need)
